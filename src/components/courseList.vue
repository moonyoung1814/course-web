<template>
    <div class="ring-2 rounded shadow w-10/12 ml-12 px-8 pb-8 relative flex flex-row flex-wrap space-x-6">
        <div v-for="(item,index) in course" :key="index"> 
            <div class="flex flex-col mt-8" v-if="item.name == '创新实践' + isPractice">
